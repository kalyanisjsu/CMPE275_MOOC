...
public class ResourceUtil {
	...
	public static Header buildHeader(Routing path, PokeStatus status, String msg, String from, String tag) {
		...
		bldr.setOriginator("server");
		bldr.setRoutingId(Routing.JOBS);
		bldr.setTag("Voting");
    ...
    public static Request buildVotingIsLeader(String hostIp, String portId){
        ...
        builder.setOriginator("server");
        builder.setRoutingId(Routing.JOBS);
        builder.setTag("Voting");

        bldr.setHeader(builder.build());
