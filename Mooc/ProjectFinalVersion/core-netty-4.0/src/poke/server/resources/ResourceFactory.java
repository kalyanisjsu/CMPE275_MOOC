...
public class ResourceFactory {
	...
	public Resource resourceInstance(Header header) {
		...
		/*if(header.getTag().equals("SignIn"))
		{
			System.out.println("***** Inside Header Signin*****");
			//SignInResource signInResource = new SignInResource();
			//return signInResource;
		}
		
		if(header.getTag().equals("SignUp"))
		{
